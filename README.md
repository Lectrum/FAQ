...
- [🌏 Настройка окружения](#-Настройка-окружения)
    ...
    - [Что такое синхронизация, которую мы будем использовать в рамках обучения? И зачем она?](#Как-настроить-postcss-в-vscode)
    - [Как работает синхронизация?](#Как-настроить-postcss-в-vscode)
    - [Как проверить, что синхронизация работает?](#Как-настроить-postcss-в-vscode)
