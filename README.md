...
2. Прочитай текст ошибки, попытайся понять её суть: чаще всего текст ошибки сам по себе объясняет в чем проблема. Самая частая ошибка — `Error: listen EADDRINUSE 0.0.0.0:3000`. Давай разберемся как её решить. Читаем:
