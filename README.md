...
- [🌏 Настройка окружения](#Настройка-окружения)
    ...
    - [Я пользователь Windows. Как настроить терминал, чтобы работало хорошо?](#Я-пользователь-windows-Как-настроить-терминал-чтобы-работало-хорошо)
...
#### Я пользователь Windows. Как настроить терминал, чтобы работало хорошо?
