...
- [🌏 Настройка окружения](#-Настройка-окружения)
    ...
    - [Зачем мне устанавливать Node.js именно через nvm?](#Как-установить-nodejs)
...
С помощью nvm можно держать на одном компьютере сразу несколько разных версий Node.js, и затем легко и быстро переключатся между ними. Каждая версия находится в изолированном и независимом окружении, что очень удобно — одна версия Node.js никогда ничего не сломает в другой версии.
