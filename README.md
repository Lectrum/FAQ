...
+ Перейди в директорию с обучающим проектом, выполни `npm install`;
...
+ Если ты видишь сообщение `«Поехали!»`, то синхронизация работает, во время обучения ты сможешь воспользоваться ей в любой момент;
+ Если ты видишь сообщение `«Добро пожаловать»!, то на твоём компьютере синхронизация не работает. Но не переживай ты всё равно можешь синхронизироваться с преподавателем в любой момент [следуя этой
