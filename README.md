...
- [🏎 Запуск и работа с проектом](#-Запуск-и-работа-с-проектом)
    - [❓ Вопрос: У меня не запускается проект. Что делать?](#-У-меня-не-запускается-проект-что-делать)
...
- [✏️ Качество кода: настройка редакторов и IDE](#️-Качество-кода-настройка-редакторов-и-ide)
    ...
    - [❓ Вопрос: Как настроить `Prettier` с `ESlint`, чтобы можно было форматировать код по нажатию сочетания клавиш:](#-Как-настроить-prettier-с-eslint-чтобы-можно-было-форматировать-код-по-нажатию-сочетания-клавиш)
